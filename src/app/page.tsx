  ...
  const features = [
    {
      ...
      description:
        "Holistic, adaptive performance programs designed to support anxiety, depression, and cognitive wellness through mindful movement.",
    },
    {
      image: "/bedside-mobility.png",
      title: "Bedside Mobility",
      description:
        "Pioneering exercise protocols for those currently bedbound or with restricted mobility, ensuring fitness is accessible to all.",
    },
    {
      image: "/adaptive-strength.png",
      title: "Adaptive Strength",
      description:
        "Elite level strength training for athletes with physical disabilities, utilizing specialized equipment and expert coaching.",
    },
    {
      image: "/chronic-care.png",
      title: "Chronic Care Support",
      description:
        "Targeted training for long-term health challenges like MS, Parkinson's, and personalized stroke recovery protocols.",
    },
    {
      image: "/post-surgery-v2.png",
      title: "Post-Surgery Recovery",
      description:
        "Safe, expert-led re-entry into physical activity following medical procedures, prioritizing healing and functional strength.",
    },
    {
      image: "/neuro-spaces.png",
      title: "Neurodivergent Spaces",
      description:
        "A sensory-optimized, calm environment designed specifically for the comfort and focus of neurodivergent athletes.",
    },
    {
      image: "/pain-relief-v2.png",
      title: "Chronic Pain relief",
      description:
        "Gentle, science-backed movement strategies and mobility drills to help manage and mitigate chronic pain conditions.",
    },
    {
      image: "/para-sport.png",
      title: "Para-Sport Excellence",
      description:
        "Elite conditioning for competitive para-athletes, focusing on explosive performance and sport-specific training.",
    },
  ];
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none select-none opacity-[0.03] z-0 px-4">
          <span className="text-[15vw] md:text-[20vw] font-black uppercase leading-none block">
            STRENGTH
          </span>
          <span className="text-[15vw] md:text-[20vw] font-black uppercase leading-none block text-green-600">
            LIMITLESS
          </span>
        </div>
        ...
        <div className="relative z-10 container mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            <div className="max-w-xl">
              <span className="text-green-600 font-bold uppercase tracking-[0.3em] mb-4 block text-sm">
                Our Philosophy
              </span>
              <h2 className="text-4xl sm:text-6xl md:text-8xl font-black uppercase leading-[0.85] tracking-tighter text-slate-900">
                WHY <br />
                <span
                  className="text-transparent border-b-8 border-green-500 pb-2"
                  style={{ WebkitTextStroke: "2px #0f172a" }}
                >
                  CHOOSE
                </span>{" "}
                <br />
                <span className="text-green-600">PRIME?</span>
              </h2>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="lg:w-1/2 space-y-10">
              ...
              <div className="text-slate-600 text-lg leading-relaxed space-y-6 font-medium max-w-xl">
                <p>
                  We believe strength is not about pushing beyond limits, it is
                  about discovering what is possible for your body today.
                </p>
                <p>
                  Our adaptive training is thoughtfully designed for individuals
                  with mobility limitations, neurological conditions, recovery
                  needs, and mental health challenges. Whether you are
                  rebuilding strength after surgery, managing a chronic
                  condition, navigating physical disability, or seeking
                  structured movement for emotional well-being, we provide a
                  safe and supportive environment tailored to you.
                </p>
                <p>
                  Here, progress is guided by professional assessment,
                  individualized programming, and compassionate coaching. We
                  adapt the training, not the person.
                </p>
                <p>
                  Because everybody deserves access to movement, dignity, and
                  growth.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6">
                {[
                  ...
                  <div key={i} className="flex gap-5">
                    ...
                    <div>
                      <h4 className="text-slate-900 font-bold uppercase tracking-wide mb-1 text-base">
                        {item.title}
                      </h4>
            ...
            <div className="lg:w-1/2 relative w-full">
              <div className="relative aspect-square sm:aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-slate-100 group">
                {/* Main Image */}
                <Image
                  src="https://images.pexels.com/photos/8436608/pexels-photo-8436608.jpeg"
      ...
      <section className="py-20 md:py-32 bg-slate-900 text-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto">
          <h2 className="text-4xl sm:text-6xl md:text-9xl font-black mb-12 text-white uppercase leading-none tracking-tighter">
            BREAK YOUR <br />
            <span className="text-green-500 italic">LIMITS.</span>
          </h2>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center relative z-20">
            <Link
              href="/contact"
              className="bg-green-500 text-slate-900 px-16 py-6 rounded-full font-black text-2xl uppercase hover:bg-white hover:scale-105 transition-all shadow-[0_10px_0_0_#166534] active:shadow-none active:translate-y-[10px] inline-block cursor-pointer pointer-events-auto"
            >
              Start Now
            </Link>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-2/5 space-y-12">
              <div>
                <span className="text-green-500 font-bold uppercase tracking-[0.3em] mb-4 block text-sm">
                  Get In Touch
                </span>
                ...
                <p className="text-slate-300 text-xl font-medium leading-relaxed max-w-md">
                  ...
                  or membership? Our team is ready to help you start your
                  journey.
                </p>
              </div>
                  ...
                  {!isSuccess ? (
                    ...
                    >
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-3">
                          ...
                          <select
                            name="inquiry"
                            className="w-full bg-white/5 border-2 border-transparent focus:border-green-500 focus:bg-white/10 p-5 rounded-2xl transition-all outline-none font-medium text-white appearance-none cursor-pointer"
                          >
                            <option className="bg-slate-900">
                              Personal Adaptive Fitness Training
                            </option>
                            <option className="bg-slate-900">
                              Adaptive Athletics
                            </option>
                      ...
                      >
                        ...
                        {!isSubmitting && (
                          <Send className="group-hover/btn:translate-x-2 group-hover/btn:-translate-y-1 transition-transform" />
                        )}
                      </button>
                    </motion.form>
                  ) : (
                    ...
                    >
                      ...
                      <p className="text-slate-400 font-medium max-w-sm mx-auto">
                        Thank you for reaching out to Prime Fitness Plus. One of
                        our elite coaches will contact you shortly to discuss
                        your goals.
                      </p>
                      <button
