...
const HeroSlider = () => {
  ...
  const images = [
    {
      url: "/slide3.jpg",
      title: "Inclusive Movement for Mobility,\n Recovery, and Mental Wellness",
      subtitle:
        "Movement is not just physical; it supports emotional and cognitive well-being too.",
    },
    {
      url: "/slide1.jpg",
      title: "Fitness Without Barriers",
      subtitle:
        "Our community welcomes athletes of all abilities, including adaptive and disabled athletes.",
    },
    {
      url: "/slide2.jpg",
    ...
    },
    {
      ...
      subtitle:
        "Adaptive fitness programs designed to meet your unique needs and goals.",
    },
    {
      url: "/slide5.jpg",
      title: "Accessible and Inclusive",
      subtitle:
        "State-of-the-art accessible equipment and specialized coaching for everyone.",
    },
  ];
    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-start justify-end h-full w-full text-left px-6 md:px-16 lg:px-24 pb-20  md:pb-32">
        <AnimatePresence mode="wait">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter leading-[1.1] font-heading drop-shadow-xl max-w-5xl ">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-start pt-4 relative z-50">
              <Link
                href="/contact"
                className="px-10 py-4 bg-green-500 hover:bg-white hover:text-slate-900 rounded-full font-black text-slate-900 text-lg transition-all hover:scale-105 shadow-2xl pointer-events-auto cursor-pointer uppercase tracking-widest"
              >
                Get Started
              </Link>
            </div>
