        ...
        <div className="space-y-4 pt-6 border-t border-slate-100">
          ...
          <div className="flex flex-wrap gap-2">
            {trainer.specialties.map((spec, sIdx) => (
              <span
                key={sIdx}
                className="px-4 py-1.5 bg-slate-50 text-slate-900 text-[10px] font-bold uppercase tracking-widest rounded-full border border-slate-100 transition-colors hover:bg-green-600 hover:text-white hover:border-green-600"
              >
                {spec}
              </span>
            ))}
            ...
            {[
              ...
              >
                <div className="flex items-baseline gap-4">
                  <span className="text-4xl font-black text-green-600/20 tabular-nums">
                    0{idx + 1}
                  </span>
        ...
        <div className="bg-slate-900 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-16 relative overflow-hidden group">
          ...
          <div className="relative z-10 max-w-2xl space-y-8">
            ...
            <p className="text-xl text-slate-400 font-medium max-w-xl">
              Our team is ready to help you unlock your full potential. Book a
              consultation with one of our specialists today.
            </p>
            <a
              href="/contact"
              className="inline-flex items-center gap-6 bg-green-600 hover:bg-white hover:text-green-600 text-white px-12 py-6 rounded-2xl font-black uppercase tracking-[0.2em] transition-all duration-500 shadow-2xl hover:scale-105 active:scale-95 group/btn"
            >
              Book Consultation
              <Zap
                size={20}
                className="fill-current group-hover/btn:animate-pulse"
              />
            </a>
          </div>
        </div>
